...
## 0. Introduction   
    ...
    this is the code that I conjugate with the libraries from Python, crowling the html source and send http messages to get information. but it's just rough code, and I programed to just one text file in a day. if you have to try again to search, you have to delete the text file.
